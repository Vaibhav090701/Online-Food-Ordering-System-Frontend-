...
export const restaurentReducer=(state=initialState,action)=>{
    ...
    switch (action.type) {
        ...
        case GET_RESTAURENT_BY_CITY_REQUEST:
            return{
                ...state,
                isLoading:true,
                error:null,
        ...
        case GET_RESTAURENT_BY_CITY_SUCCESS:
            return {
                ...state, allRestaurents:action.payload, error:null, isLoading:false
            };
        ...
        case GET_RESTAURENT_BY_CITY_FAILURE:
            return{
                ...state,
                isLoading:false,
