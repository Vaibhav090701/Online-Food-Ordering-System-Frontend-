...
export const GET_MENU_ITEMS_BY_RESTAURENT_ID_REQUEST="GET_MENU_ITEMS_BY_RESTAURENT_ID_REQUEST";
export const GET_MENU_ITEMS_BY_RESTAURENT_ID_SUCCESS="GET_MENU_ITEMS_BY_RESTAURENT_ID_SUCCESS";
export const GET_MENU_ITEMS_BY_RESTAURENT_ID_FAILURE="GET_MENU_ITEMS_BY_RESTAURENT_ID_FAILURE";
...
export const GET_RESTAURENT_MENU_REQUEST="GET_RESTAURENT_MENU_REQUEST";
export const GET_RESTAURENT_MENU_SUCCESS="GET_RESTAURENT_MENU_SUCCESS";
export const GET_RESTAURENT_MENU_FAILURE="GET_RESTAURENT_MENU_FAILURE";

export const GET_MENU_ITEM_BY_CATEGORY_REQUEST="GET_MENU_ITEM_BY_CATEGORY_REQUEST";
export const GET_MENU_ITEM_BY_CATEGORY_SUCCESS="GET_MENU_ITEM_BY_CATEGORY_SUCCESS";
export const GET_MENU_ITEM_BY_CATEGORY_FAILURE="GET_MENU_ITEM_BY_CATEGORY_FAILURE";
