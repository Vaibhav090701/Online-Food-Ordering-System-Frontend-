...
export const GET_RESTAURENTS_EVENTS_REQUEST="GET_RESTAURENTS_EVENTS_REQUEST";
export const GET_RESTAURENTS_EVENTS_SUCCESS="GET_RESTAURENTS_EVENTS_SUCCESS";
export const GET_RESTAURENTS_EVENTS_FAILURE="GET_RESTAURENTS_EVENTS_FAILURE";
