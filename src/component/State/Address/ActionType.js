...
export const UPDATE_ADDRESS_DEFAULT_REQUEST="UPDATE_ADDRESS_DEFAULT_REQUEST";
export const UPDATE_ADDRESS_DEFAULT_SUCCESS="UPDATE_ADDRESS_DEFAULT_SUCCESS";
export const UPDATE_ADDRESS_DEFAULT_FAILURE="UPDATE_ADDRESS_DEFAULT_FAILURE";
