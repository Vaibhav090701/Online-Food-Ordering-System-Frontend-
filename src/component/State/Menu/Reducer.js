...
export const menuItemReducer=(state=initialState,action)=>{
    ...
    switch (action.type) {
        ...
        case GET_MENU_ITEMS_BY_RESTAURENT_ID_REQUEST:
        ...
        case GET_MENU_ITEMS_BY_RESTAURENT_ID_SUCCESS:
            return {
                ...state,
                isLoading:false,
        ...
        case DELETE_MENU_ITEM_SUCCESS:
            return{
                ...state,
                isLoading:false,
                menuItems:state.menuItems.filter((item)=>item!==action.payload),
            };
        ...
        case GET_MENU_ITEMS_BY_RESTAURENT_ID_FAILURE:
